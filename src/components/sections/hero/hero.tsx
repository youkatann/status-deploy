...
export default function Hero ({ children, distance = 0.6 }: IHeroProps) {
  ...
  return (
    <section ref={container} className="relative flex h-svh overflow-clip">
    <motion.div 
      style={{
        y: scrollAnimationY,
      }}
    ...
    <div className="relative grid grid-cols-10 grid-rows-10 h-svh w-full px-12 py-6">
    <motion.h1 
    style={{
      y: scrollAnimationY1
    }}
    className="initial z-[5] col-start-1 col-end-5 row-start-3 row-end-7 text-[110px] leading-[0.8] tracking-tighter text-pretty font-medium indent-60">Англійська для всіх, <span className="font-extrabold">для бізнесу, дорослих та дітей</span></motion.h1>
    <motion.div 
