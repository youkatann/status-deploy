...
export default function Home() {
  ...
  return (
    <section onMouseMove={(e) => {manageMouseMove(e)}} className="flex h-screen w-full overflow-hidden relative justify-center items-center border-t-2 border-black">
      <div ref={plane1} className="z-[10] w-full h-full absolute *:absolute *:w-[400px]">
          <div className='bg-white flex flex-col p-4 border-2 border-black shadow-brutalism bg-pinkLight left-[75%] top-[45%]'>
            <div className='flex justify-center items-center'>
            <img className='w-[150px] h-[150px]' src='/images/bshape1.svg'/>
            </div>
            ...
            <motion.button className="z-[13] px-9 py-4 border-2 border-black shadow-brutalism bg-purpleLight mt-6" type="submit"
          ...
          <div className='bg-white flex flex-col p-4 border-2 border-black shadow-brutalism left-[15%] top-[35%]'>
          <div className='flex justify-center items-center'>
            <img className='w-[150px] h-[150px]' src='/images/bshape2.svg'/>
            </div>
          <h4 className='text-2xl font-extrabold'>Набір нових студентів у групу 101</h4>
            <p className='text-lg font-medium mt-4'>Оголошуємо про набір нових студентів у групу 101, у зв'язку із випуском курсу</p>
            <motion.button className="z-[13] px-9 py-4 border-2 border-black shadow-brutalism bg-purpleLight mt-6" type="submit"
          ...
          <div className='bg-white flex flex-col p-4 border-2 border-black shadow-brutalism left-[45%] top-[0%]'>
          <div className='flex justify-center items-center'>
            <img className='w-[150px] h-[150px]' src='/images/bshape3.svg'/>
            </div>
          <h4 className='text-2xl font-extrabold'>Набір нових студентів у групу 101</h4>
            <p className='text-lg font-medium mt-4'>Оголошуємо про набір нових студентів у групу 101, у зв'язку із випуском курсу</p>
            <motion.button className="z-[13] px-9 py-4 border-2 border-black shadow-brutalism bg-purpleLight mt-6" type="submit"
          ...
          > 
            ...
            <div className='z-[10] bg-white flex flex-col p-4 border-2 border-black shadow-brutalism left-[45%] top-[60%]'>
      <div className='flex justify-center items-center'>
            <img className='w-[150px] h-[150px]' src='/images/bshape1.svg'/>
            </div>
      <h4 className='text-2xl font-extrabold'>Набір нових студентів у групу 101</h4>
      ...
      <div className='z-[10] p-8 border-2 border-black bg-white shadow-brutalism'>
        <h1 className='font-black text-black text-center text-6xl'>Новини Status</h1>
        <p className='font-semibold text-black text-xl mt-3 text-center'>Актуально про нас</p>
      </div>
      <div
