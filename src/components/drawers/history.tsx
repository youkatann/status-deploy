...
export default function HistoryDrawer (props: IHistoryDrawerProps) {
  return (
    ...
    <div className='z-[10] flex gap-12 items-start justify-end'>
      <div className='flex flex-col w-[40%] gap-12  items-end mt-24'>
        ...
        <div className='p-12 bg-roseLight border-2 border-black shadow-brutalism flex flex-col gap-12'>
      ...
      <div className='flex flex-col w-[40%] gap-12  items-end mt-16'>
        <h3 className='text-7xl text-primary-content font-black p-4 border-2 border-black shadow-brutalism bg-greenLight'>2017</h3>
        <div className='p-12 bg-greenLight border-2 border-black shadow-brutalism flex flex-col gap-12'>
          <div className='flex justify-center items-center'>
      ...
      <div className='flex flex-col w-[35%] gap-12  items-end mt-12'>
        <h3 className='text-6xl text-primary-content font-black p-4 border-2 border-black shadow-brutalism bg-blueLight'>2012</h3>
        <div className='p-12 bg-blueLight border-2 border-black shadow-brutalism flex flex-col gap-12'>
          <div className='flex justify-center items-center'>
      ...
      <div className='flex flex-col w-[35%] gap-12  items-end mt-8'>
        <h3 className='text-6xl text-primary-content font-black p-4 border-2 border-black shadow-brutalism bg-pinkLight'>2011</h3>
        <div className='p-12 bg-pinkLight border-2 border-black shadow-brutalism flex flex-col gap-12'>
          <div className='flex justify-center items-center'>
      ...
      <div className='flex flex-col w-[30%] gap-12 items-end'>
        <h3 className='text-5xl text-primary-content font-black p-4 border-2 border-black shadow-brutalism bg-purpleAccent'>2007</h3>
        <div className='p-12 bg-purpleAccent border-2 border-black shadow-brutalism flex flex-col gap-12'>
          <div className='flex justify-center items-center'>
